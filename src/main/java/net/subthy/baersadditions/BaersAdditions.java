package net.subthy.baersadditions;
...
@Mod(BaersAdditions.MOD_ID)
public class BaersAdditions {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "baersadditions";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    public BaersAdditions() {
